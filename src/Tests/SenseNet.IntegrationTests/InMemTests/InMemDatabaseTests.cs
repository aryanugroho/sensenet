...
{
    [TestClass]
    public class InMemDatabaseTests : IntegrationTest<InMemPlatform, DatabaseTests>
    {
        ...
        private int[] GetReferencesFromDb(Node node, PropertyType propertyType)
        {
            ...
            return value == null ? Array.Empty<int>() : value.ToArray();
        }

        [TestMethod]
        public void IntT_InMem_DB_ReferenceProperties()
        {
